...
--------
	...
	Libraries used - Plotly, Scikit learn, Pandas, Numbpy, Matplotlib
	...
	About the project: An analysis of the corona cases of different countries around the globe, the doubling rate associated and the general trend.
			    Alongwith this, implementation of SIR (Susceptible population, Infectious population and Recovered population) for Canada, Germany, Kuwait.
